...
/**
 * Interface that defines the functionality expected from the media rental
 * manager. The two possible media we can have are movies and music albums. A
 * movie has a title, a number of copies that are available for rent, and a
 * rating (e.g., "PG"). An album has a title, a number of copies, an artist, and
 * a list of songs (String with title of songs separated by commas).<br>
 * <br>
 * <b>IMPORTANT:</b>The database of the media rental manager, must define and
 * use two ArrayList. One stores the media (both Movies and Album information)
 * and one stores Customer information. You will lose significant credit if you
 * do not define and use these ArrayList objects.
 * 
 * @author cmsc131
 *
 */
